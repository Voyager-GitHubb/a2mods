/// mateminco--mt35-mini/hwdef.c  
/// Mateminco MT35-Mini does not have its own hwdef.c  
/// this is a copy of emisar-d4/hwdef.c 
...
/// Mod. copied from sofirn--sc31-pro-t1616/hwdef.c  
#include "fsm/chan-aux.c"
